...
- **视觉风格**：颜色、字体、间距、圆角、边框、渐变和阴影
- **响应式效果**：桌面端、平板端和手机端的布局变化
- **交互状态**：悬停、点击、选中、展开、弹窗、抽屉和菜单
- **动画效果**：滚动显现、视差、卡片移动、数字动画和页面过渡
- **单个组件**：按钮、表单、搜索框、轮播图和定价卡片
- **完整页面**：落地页、产品官网、后台面板、作品集和博客首页
- **截图效果**：只有截图、没有网址时，也可以分析并尝试还原
- **视频中的动态效果**：分析交互过程、时间节奏和状态变化后重新实现
- **设计语言**：提取参考网站的视觉规律，再应用到你的内容和品牌中

它复制的是网站“看起来怎么样、操作起来怎么样”。网站后端、数据库、私有接口和未经授权的品牌资产不在复制范围内。
